...
function createTabDiv(tabInfo) {
  var newTabDiv = $('<div class="tab">' +
    ...
    '<div class="cover">' +
    '<img src="../../resources/icon_128.png" class="favicon">' +
...
function createSearchTabDiv(tabInfo) {
    var newTabDiv = $('<div class="tab">' +
      '<div class="id hide"></div>' +
      '<div class="delete"></div>' +
      '<div class="cover">' +
    ...
    newTabDiv.find('.id').text(tabInfo.id);
    newTabDiv.find('.title').text("keyword:" + tabInfo.keyword + " " + tabInfo.title);
    newTabDiv.find('.url').text(tabInfo.url);
